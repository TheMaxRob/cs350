//THIS CODE IS MY OWN WORK, IT WAS WRITTEN WITHOUT CONSULTING A TUTOR, CODE WRITTEN BY OTHER STUDENTS, OR CODE DERIVED FROM AN AI TOOL- YOUR NAME
...
PPMImage * new_ppmimage( unsigned int w, unsigned int h, unsigned int m )
{
	...
	for (int channel = 0; channel < 3; channel++) {
		...
		img->pixmap[channel] = (unsigned int **)malloc(h * sizeof(unsigned int *));
